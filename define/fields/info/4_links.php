...
$info_fields = array(opendmo_field_build_tab('Links'));
...
for($xxu = 0; $xxu<$limit['ext_links']; $xxu++) {
    ...
    $info_fields = array_merge($info_fields, array (
	    ...
	    $linksrow[0],
        opendmo_field_build_text("ext_link_label_$xxu", "External Link Label $lridx", $the_suggestll),
        opendmo_field_build_text("ext_link_url_$xxu", "Website URL $lridx", "https://"),
        $linksrow[1],
